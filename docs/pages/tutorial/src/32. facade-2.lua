-----------------------------------------------------------------------------------------------------------------------
-- Scribe Tutorial: Add a check that any user-supplied set of formatting options is complete.
--
...
function scribe(obj, opts)
    ...
    return table_string(obj, opts)
end

function pretty(tbl)
    return scribe(tbl, options.pretty)
end

function inline(tbl)
    return scribe(tbl, options.inline)
end

function classic(tbl)
    return scribe(tbl, options.classic)
end

function alt(tbl)
    return scribe(tbl, options.alt)
end

function json(tbl)
    return scribe(tbl, options.json)
end

function inline_json(tbl)
    return scribe(tbl, options.inline_json)
end
